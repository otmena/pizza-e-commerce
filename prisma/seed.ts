...
async function up() {
  ...
  const pizza2 = await prisma.product.create({
    data: {
      ...
      imageUrl: 
        'https://cdn.dodostatic.net/static/Img/Products/11eefb595a197c24ba932a0ad1144afb_1875x1875.jpeg',
      categoryId: 1,
      ingredients: {
  ...
  const pizza3 = await prisma.product.create({
    data: {
      name: 'Бефстроганов',
      imageUrl: 
        'https://cdn.dodostatic.net/static/Img/Products/11eef9e43c63cd828d9bc3127e7b7ad7_1875x1875.jpeg',
      categoryId: 1,
      ingredients: {
