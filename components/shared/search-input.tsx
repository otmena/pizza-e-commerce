  ...
  return (
    <>
      ...
      <div ref={ref} className={cn('flex rounded-2xl flex-1 justify-between relative h-11 z-30', className)}>
        ...
        <input type="text" className='rounded-2xl outline-none w-full bg-gray-100 pl-11' placeholder='Найди еду...' onFocus={() => setFocused(true)} onChange={(e) => setSearchQuery(e.target.value)}/>
